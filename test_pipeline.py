...
single_pair(
    moving=Path("E:\\Masters_College_Work\\RA_CyLab\\X-Ray\\data\\images\\134450-V0.bmp"),
    reference=Path("E:\\Masters_College_Work\\RA_CyLab\\X-Ray\\data\\grade_a\\143745-V0.bmp"),
    out_dir=Path("E:\\Masters_College_Work\\RA_CyLab\\X-Ray\\pipeline\\sample"),
    ckpt=Path("E:\\Masters_College_Work\\RA_CyLab\\X-Ray\\yolo_type\\runs\\segment\\train\\weights\\best.pt"),
    imgsz=640,
    conf=0.1,
